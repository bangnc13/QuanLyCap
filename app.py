...
# 2. CSS Tùy chỉnh TRÀN HẾT TẤT CẢ CÁC CẠNH (Trên - Dưới - Trái - Phải)
st.markdown("""
    <style>
        /* Reset toàn bộ khoảng trắng của trang web */
        ...
        /* Ép container chính phủ kín 100% viewport */
        ...
        /* Khắc phục gap ở cạnh trên và dưới */
        ...
        /* Ép iframe bản đồ tràn full màn hình */
        iframe {
        ...
        /* Đảm bảo Sidebar nổi lên trên bản đồ */
