...
st.markdown("""
    <style>
        ...
        [data-testid="collapsedControl"] {
            ...
            top: 12px !important;
            left: 12px !important;
            /* Màu cam FPT với độ trong suốt 50% */
        ...
        /* 5. STYLE BADGE "MAKE BY BANGNC13" VIỀN BO TRÒN MÀU XANH */
        .author-badge {
...
# Giao diện Sidebar
# Badge Make by BangNC13 góc trên bên trái
...
if df is not None:
    ...
    # Đặt zoom_control=False ĐỂ XÓA HOÀN TOÀN BIỂU TƯỢNG (+ / -) TRÊN BẢN ĐỒ
    m = folium.Map(
        location=map_center, 
        zoom_start=zoom_lvl, 
        tiles=None, 
